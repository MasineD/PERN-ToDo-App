# PERN-ToDo-App
Creating a full stack ToDo application using PostgreSQL, Express.js, React.js, and Node.js
...
Click on the image for a video of how the application works [![Project Overview](/images/landingPage.png)](https://youtu.be/82jTOxhq-1A)
